...
```bash
pyinstaller --onedir --noconsole --clean --icon=iconLINUX.png --collect-all PIL --collect-all cv2 --collect-all sounddevice --collect-all speech_recognition --hidden-import numpy --name myAssistente myAssistente4_2.py
```

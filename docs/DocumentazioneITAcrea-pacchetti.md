...
--collect-all PIL ^
--collect-all cv2 ^
--name assistente assistente3.1TEST.py

```

ATTENZIONE sovrascrive cartella /dist se precedentemente compilato con linux
...
ATTENZIONE sovrascrive cartella /dist  se precedentemente compilato con Windows
